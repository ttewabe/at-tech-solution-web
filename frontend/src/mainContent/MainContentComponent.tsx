    ...
    return (
        <MainContent>
            ...
            <AboutSection key={"about-us"}>
                ...
                <ServicesGrid>
                    <ServiceCard>
                        <ServiceCardIcon><img alt="" src={AppDevelopmentIcon} /></ServiceCardIcon>
                        <h4>Web Development</h4>
                        <p>Custom websites and web applications</p>
                    </ServiceCard>
                    <ServiceCard>
                        <ServiceCardIcon><img alt="" src={MobileDevelopmentIcon} /></ServiceCardIcon>
                        <h4>Application Development</h4>
                        <p>Mobile and Desktop applications</p>
                    </ServiceCard>
                    <ServiceCard>
                        <ServiceCardIcon><img alt="" src={EducationIcon} /></ServiceCardIcon>
            ...
            <AboutSection key={"featured-projects"}>
                ...
                <ServicesGrid className='featured-projects'>
                    <ServiceCard className='featured-project-card'>
                        ...
                        <p>
                            An ERP system integrates business processes into
                            a single system, improving efficiency and decision-making.
                        </p>
                        <p>
                    ...
                    <ServiceCard className='featured-project-card'>
                        ...
                        <p>
                            An Inventory Management System tracks and manages inventory levels,
                    ...
                    <ServiceCard className='featured-project-card'>
                        ...
                        <p>
                            An Insurance Claim Management System streamlines the process of filing,
                    ...
                    <ServiceCard className='featured-project-card'>
                        ...
                        <p>
                            A Customer Relationship Management (CRM) system helps manage interactions
